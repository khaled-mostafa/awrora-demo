...
import Hidden from '~/components/marketing/Hidden'
import CardProducts from '~/components/marketing/Cards/ProductCard'
...
export default {
  ...
  head() {
    return {
      title: 'Product List | ' + brand.marketing.desc
    }
  }
}
</script>
