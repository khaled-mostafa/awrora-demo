...
import Hidden from '~/components/agency/Hidden'
import CardProducts from '~/components/agency/Cards/ProductCard'
...
export default {
  ...
  head() {
    return {
      title: 'Product List | ' + brand.agency.desc
    }
  }
}
</script>
