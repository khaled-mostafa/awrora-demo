...
import ProductCard from '~/components/agency/Cards/ProductCard'
import ProfileCard from '~/components/agency/Cards/ProfileCard'
...
export default {
  ...
  head() {
    return {
      title: 'Collection | ' + brand.agency.desc
    }
  }
}
</script>
