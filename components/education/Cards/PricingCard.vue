<template>
  ...
  >
    <v-card-title class="price-header justify-center">
      <h5
        :class="title === 'Free' ? 'secondary--text' : 'primary--text'"
      ...
      <div class="card-pricing" :class="title === 'Free' ? 'use-text-secondary' : 'use-text-primary'">
        <h2 class="use-text-title text-xs-center">
          ${{ price }}
        </h2>
        <h6 class="title">
          &nbsp;/ mo
